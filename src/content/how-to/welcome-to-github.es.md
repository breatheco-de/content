...
> Un repositorio es solo una carpeta con los archivos de tu proyecto dentro (imágenes, código, datos, etc.). Por ejemplo, este repositorio contiene [todo el código para la biblioteca React.js](https://github.com/facebook/react) y este otro repositorio contiene [todo el código de Pandas](https://github.com/pandas-dev/pandas), una de las librerias mas usadas del mundo de los datos.
