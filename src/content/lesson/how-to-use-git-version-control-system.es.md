...
GIT es más que un "conjunto de comandos" que tienes que aprender. A lo largo de los años, hemos aprendido que la mejor manera de enseñar GIT es mediante la comprensión de los conceptos y el significado de la tecnología la puesta en practica con ejercicios integradores y dinamicos en lugar de dar una lista de los comandos que se debe usar.
