...
**Coding is not HTML, CSS or Position and Display...** Those languages were not designed for developers, they're just the way we have to render stuff in a browser.
