...
![boxmodel](https://breatheco.de/wp-content/uploads/2017/01/box.png)   
...
![titulaprincipal](https://breatheco.de/wp-content/uploads/2017/01/Screen-Shot-2017-01-14-at-11.02.06-PM.png)
...
![box-h](https://breatheco.de/wp-content/uploads/2017/01/box-css-1.gif) 
...
|Absolute    |When you tell a box that its position is absolute, you also need to define the top, bottom, left and right rules.
...
|Fixed     |If you fix an element, it means that it will stay in the same position during the whole web navigation.  If the user scrolls the web, the element will stay in the very same position.
Fixed could be used on PopUps, menu, etc.    |
...
![uxui](https://breatheco.de/wp-content/uploads/2017/01/website-layouts-300x261.png)
...
[content](https://breatheco.de/wp-content/uploads/2017/01/centered-navbar-sketch.png)
...
![final/image](https://breatheco.de/wp-content/uploads/2017/01/giphy-1-300x208.gif)
