...
+ As a developer, this is the one thing you need to have available. Computers don't come with Atom, Sublime text or any other fancy IDE. Sometimes, like on production servers, you are not allowed to install anything, and **the system does not even have a visual interface**, just the command line.
