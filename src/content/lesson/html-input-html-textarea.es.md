...
Esta lección, aunque fácil de entender, es esencial, ya que aborda los conceptos fundamentales que transmiten la interactividad en Internet. Hay algunas etiquetas HTML adicionales que debemos analizar antes de seguir con el curso: son las primeras formas posibles de interacción que se introdujeron en HTML: las entradas o inputs y los formularios.
