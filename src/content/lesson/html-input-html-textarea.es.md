...
`DISABLED`: Determina si el input será gris y de solo lectura. Los inputs deshabilitados no pueden ser enviados al servidor: actúan como si nunca hubieran existido.
