---
title: "Entendiendo HTML, Input (Entrada), área de texto (textarea) y formularios"
subtitle: "Los formularios HTML, los input HTML y el elemento textarea HTML son muy fáciles de entender, y son la ÚNICA manera de crear sitios web interactivos sin AJAX. Estos conceptos son muy básicos y representan el 90% de todo lo que siempre necesitarás saber sobre formularios."
