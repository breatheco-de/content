...
2. **Ask Why?** There is only so much we can say, we need you to raise your concerns in a private way the moment you start double guessing our methods, we do everything for a reason and I'm confident that we are going to be able to explain "the why".
