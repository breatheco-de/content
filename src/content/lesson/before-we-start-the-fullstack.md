...
- JavaScript can create HTML and CSS the same way you do: You can tell JS to write any HTML you want. The code can "write itself" if you create a smart enough website.
