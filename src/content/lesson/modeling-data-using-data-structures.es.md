...
| ---- | ---------- | --------------------- |
| Array o Lista | Es una forma de tener muchos valores o de un mismo tipo en una sola variable | Agrupar valores, relacionarlos entre si, para que sean más accesibles como hicimos con la lista anterior. El computador reservará espacios sucesivos en la memoria para todos los valores para que sea más rápido acceder a ellos |
