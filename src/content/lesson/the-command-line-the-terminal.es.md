...
+ Como desarrollador, esto es lo único que necesitas tener disponible. Las computadoras no vienen con Atom, Sublime text o cualquier otro IDE de alta calidad. A veces, por ser servidores de producción, no puedes instalar nada (y **el sistema ni siquiera tiene una interfaz visual**), solo la línea de comandos.
