...
+ Archivos ocultos: Por lo general, un archivo tiene un nombre y una extensión *(filename.extension)*. Si un archivo no tiene nombre y solo tiene una extensión, estará, por defecto, oculto en la interfaz visual.
