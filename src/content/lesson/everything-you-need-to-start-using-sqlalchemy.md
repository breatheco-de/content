...
```py
# Fetch all record from a particular table/model
...
# Get a group of records based on a query, in this case, to be called "alex".
...
Similarly, if you use UPDATE to make changes to your database, you can undo them using the ROLLBACK command but only if you have not yet used the COMMIT command in this way:
